# mforman's zmk-config

This is my personal [ZMK firmware](https://github.com/zmkfirmware/zmk/)
configuration. It consists of a 34-keys base layout that can be re-used for various
boards. It's currently only used for my [Urchin](https://github.com/duckyb/urchin)
...
- Combos for things that require a reach on a bigger keyboard 
...
![](draw/keymap.png)
([Click here](https://raw.githubusercontent.com/mforman/zmk-config/refs/heads/urchin/draw/base.svg)
